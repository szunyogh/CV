...
class _$_School implements _School {
  ...
  @override
  String toString() {
    return 'School(id: $id, beginning: $beginning, completion: $completion, department: $department, qualification: $qualification, schoolName: $schoolName)';
  }
